  ...
  return (
    <div className="Showcase" id="showcase">
        ...
        <div className="Showcase__bottom">
          <a rel="noreferrer" target='_blank' href="https://github.com/mathvaillant">
            <img src={Github} alt="" width={30} height={30}/>
          </a>
          <a rel="noreferrer" target='_blank' href="https://www.linkedin.com/in/matheus-vaillant-03781b11b/">
